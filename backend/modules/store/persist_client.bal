    ...
    private final record {|psql:SQLMetadata...;|} metadata = {
        [USER]: {
            ...
            fieldMetadata: {
                ...
                asgardeoUserId: {columnName: "asgardeo_user_id"},
                lastLogin: {columnName: "last_login"},
                loginCount: {columnName: "login_count"},
        ...
        [FARMER]: {
            ...
            fieldMetadata: {
                ...
                "user.asgardeoUserId": {relation: {entityName: "user", refField: "asgardeoUserId", refColumn: "asgardeo_user_id"}},
                "user.lastLogin": {relation: {entityName: "user", refField: "lastLogin", refColumn: "last_login"}},
                "user.loginCount": {relation: {entityName: "user", refField: "loginCount", refColumn: "login_count"}},
